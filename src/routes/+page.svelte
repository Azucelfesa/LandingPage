			...
			setTimeout(() => {
				...
				allTitles.forEach(title => {
					title.addEventListener('mouseenter', () => {
						...
						(title as HTMLElement).style.textShadow = '0 0 20px rgba(234, 179, 8, 0.6)';
					...
					<div class="curso-section curso-galeria">
						...
						<div class="responsive-grid">
							<div class="grid-item large">
								<img src="/mentor/1.jpg" alt="Opinión de nuestros alumnos" class="grid-image">
								<div class="grid-overlay">
									<div class="grid-content">
										<h4 class="grid-title">Opinión de nuestros alumnos</h4>
										<p class="grid-desc">Lo que dicen nuestros estudiantes</p>
									</div>
								</div>
								<!-- Social Media Links -->
								<div class="social-overlay">
									<a href="https://www.instagram.com/s/aGlnaGxpZ2h0OjE4MDcyNTI5NzQ1MTY5MTM0?story_media_id=3633371132684015337_45037645070&igsh=dGZmbnlreDRhMjZz" target="_blank" rel="noopener noreferrer" class="social-link-item">
							...
							<div class="grid-item medium">
								<img src="/mentor/2.jpg" alt="Nuestras clases" class="grid-image">
								<div class="grid-overlay">
									<div class="grid-content">
										<h4 class="grid-title">Nuestras clases</h4>
										<p class="grid-desc">Metodología efectiva</p>
									</div>
								</div>
								<!-- Social Media Links -->
								<div class="social-overlay">
									<a href="https://www.youtube.com/watch?v=2p06lD7NB9w" target="_blank" rel="noopener noreferrer" class="social-link-item">
										<svg viewBox="0 0 24 24" fill="currentColor">
								...
								<div class="grid-item medium">
									<img src="/mentor/4.jpg" alt="Tips de estudio" class="grid-image">
									<div class="grid-overlay">
										<div class="grid-content">
											<h4 class="grid-title">Tips de estudio</h4>
											<p class="grid-desc">Consejos para el éxito</p>
										</div>
									</div>
									<!-- Social Media Links -->
									<div class="social-overlay">
										<a href="https://www.tiktok.com/@adneduca/video/7543452126819667220?is_from_webapp=1&sender_device=pc&web_id=7554154146480522764" target="_blank" rel="noopener noreferrer" class="social-link-item">
											<svg viewBox="0 0 24 24" fill="currentColor">
												<path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/>
											</svg>
										</a>
...
/* 
	@keyframes textGlow {
		...
		to {
			text-shadow: 0 0 25px rgba(37, 99, 235, 0.9), 0 0 40px rgba(234, 179, 8, 0.6), 0 0 50px rgba(59, 130, 246, 0.4);
		}
	} */
	...
	@keyframes textPulse {
		...
		50% { 
			...
			/* text-shadow: 0 0 30px rgba(234, 179, 8, 0.8), 0 0 40px rgba(96, 165, 250, 0.5); */
		}
	}
	...
	@keyframes textZoom {
		...
		50% { 
			...
			/* text-shadow: 0 0 30px rgba(234, 179, 8, 0.8), 0 0 40px rgba(234, 179, 8, 0.6), 0 0 50px rgba(59, 130, 246, 0.4); */
		}
	}
	...
	@keyframes textZoomSmooth {
		...
		50% { 
			...
			/* text-shadow: 0 0 16px rgba(234, 179, 8, 0.6), 0 0 24px rgba(234, 179, 8, 0.3); */
		}
	}
	...
	@keyframes textZoomRotate {
		...
		50% { 
			...
			/* text-shadow: 0 0 25px rgba(59, 130, 246, 0.8), 0 0 35px rgba(234, 179, 8, 0.6), 0 0 45px rgba(234, 179, 8, 0.4); */
		}
	}
	...
	@keyframes textZoomUltra {
		...
		50% { 
			transform: scale(1.2) translateY(-8px);
			/* text-shadow: 0 0 27px rgba(234, 179, 8, 0.8), 0 0 40px rgba(234, 179, 8, 0.6), 0 0 50px rgba(59, 130, 246, 0.4); */
		}
	}
...
/* 
	...
	@keyframes floating {
		...
		20% { 
			...
			/* box-shadow: 
				0 20px 40px rgba(234, 179, 8, 0.6),
				0 0 30px rgba(234, 179, 8, 0.4),
	...
	*/
	...
	.curso-intro {
		border-color: rgba(234, 179, 8, 0.4);
		/*background: linear-gradient(135deg, rgba(249, 115, 22, 0.05) 0%, rgba(96, 165, 250, 0.05) 50%, rgba(59, 130, 246, 0.05) 100%);*/
	}
	...
	.grid-item:hover .social-overlay {
		opacity: 1;
